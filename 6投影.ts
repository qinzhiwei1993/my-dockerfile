...
var uniforColor: WebGLUniformLocation
var unifromAnim: WebGLUniformLocation
var animTime = 0
...
function init(): void {
  ...
  // projectMat， left， right，bottom，top，near， far
  // 投影出一个长方体，宽：canvas.clientWidth， 高：canvas.clientHeight， 深度：2000
  ...
  /**
   * 将显卡中的静态变量与内存中的某个变量进行绑定
   */  
  uniforColor = webgl.getUniformLocation(programObject, 'color') as WebGLUniformLocation
  unifromAnim = webgl.getUniformLocation(programObject, 'anim') as WebGLUniformLocation
  ...
  indexBuffer = webgl.createBuffer() as WebGLBuffer
  /**
